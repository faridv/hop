...
window.onload = function() {
  ...
  window.onkeydown = function(event) {
	  switch(event.keyCode) {
		  ...
		  case 403: case window.VK_RED:
				window.location.replace("../../redbutton/index.php"); //exit	 
			
		  case 404: case window.VK_GREEN:
				window.location.replace("../../redbutton/index.php?autostart=true"); //return 
