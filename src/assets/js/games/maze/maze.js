...
var camera = undefined,
    ...
    ballRadius = 0.25,
    keyAxis = [0, 0],
    ironTexture = THREE.ImageUtils.loadTexture('assets/img/games/maze/ball.png'),
    planeTexture = THREE.ImageUtils.loadTexture('assets/img/games/maze/concrete.png'),
    brickTexture = THREE.ImageUtils.loadTexture('assets/img/games/maze/brick.png'),
    gameState = undefined,
...
function updateRenderWorld() {
    ...
    tempMat.multiply(ballMesh.matrix);
    ballMesh.matrix = tempMat;
    ballMesh.rotateOnAxis(ballMesh.matrix);
...
window.launchMaze = function (container) {
    // Create the renderer.
