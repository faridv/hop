...
const babelRuntimeHelpers = require.resolve(
...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    resolve: {
      ...
      modules: [path.resolve(__dirname, '../node_modules'), 'node_modules', paths.appNodeModules].concat(
      ...
      alias: {
        ...
        // axios: path.resolve(__dirname, '../node_modules/axios'), // Force Webpack to use the correct version
        'react-dom': path.resolve(__dirname, '../node_modules/react-dom'), // Force Webpack to use the correct version
